    ...
    var placeholderProps = {
      ...
      attributes: {
        ...
        style: {
          ...
          WebkitUserModify: IS_SAFARI ? "inherit" : void 0
        },
...
var useChildren = (props) => {
  ...
  for (var i2 = 0; i2 < node.children.length; i2++) {
    var p = path.concat(i2);
    var n3 = node.children[i2];
    ...
    if (Element2.isElement(n3)) {
      ...
      children.push(import_react.default.createElement(MemoizedText, {
        decorations: ds,
        key: key.id,
        isLast: isLeafBlock && i2 === node.children.length - 1,
        parent: node,
        renderPlaceholder,
        renderLeaf,
        text: n3
...
var Editable = (props) => {
  var defaultRenderPlaceholder = (0, import_react.useCallback)((props2) => import_react.default.createElement(DefaultPlaceholder, Object.assign({}, props2)), []);
  var {
    autoFocus,
...
var DefaultPlaceholder = (_ref) => {
  ...
  return (
    ...
    import_react.default.createElement("span", Object.assign({}, attributes), children, IS_ANDROID && import_react.default.createElement("br", null))
  );
};
var defaultDecorate = () => [];
