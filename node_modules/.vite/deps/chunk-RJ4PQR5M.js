...
var Editor = {
  ...
  elementReadOnly(editor) {
    ...
    return Editor.above(editor, _objectSpread$8(_objectSpread$8({}, options), {}, {
      match: (n2) => Element.isElement(n2) && Editor.isElementReadOnly(editor, n2)
    }));
  },
  /**
  ...
  hasBlocks(editor, element) {
    return element.children.some((n2) => Element.isElement(n2) && Editor.isBlock(editor, n2));
  },
  /**
   ...
   */
  isElementReadOnly(editor, value) {
  ...
  *levels(editor) {
    ...
    for (var [n2, p2] of Node.levels(editor, path)) {
      ...
      levels.push([n2, p2]);
      if (!voids && Element.isElement(n2) && Editor.isVoid(editor, n2)) {
        break;
      }
    }
    if (reverse) {
  ...
  marks(editor) {
    ...
    if (anchor.offset === 0) {
      ...
      var markedVoid = Editor.above(editor, {
        match: (n2) => Element.isElement(n2) && Editor.isVoid(editor, n2) && editor.markableVoid(n2)
      });
      if (!markedVoid) {
  ...
  *nodes(editor) {
    ...
    var nodeEntries = Node.nodes(editor, {
      ...
      pass: (_ref) => {
        ...
        if (!voids && (Editor.isVoid(editor, node2) || Editor.isElementReadOnly(editor, node2))) return true;
  ...
  *positions(editor) {
  ...
  void(editor) {
    var options = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    return Editor.above(editor, _objectSpread$8(_objectSpread$8({}, options), {}, {
      match: (n2) => Element.isElement(n2) && Editor.isVoid(editor, n2)
    }));
  },
  /**
...
var NodeTransforms = {
  ...
  liftNodes(editor) {
    ...
    Editor.withoutNormalizing(editor, () => {
      ...
      if (match == null) {
        match = Path.isPath(at) ? matchPath(editor, at) : (n2) => Element.isElement(n2) && Editor.isBlock(editor, n2);
      }
      if (!at) {
        return;
      }
    ...
    Editor.withoutNormalizing(editor, () => {
      ...
      if (match == null) {
        if (Path.isPath(at)) {
          ...
          match = (n2) => Element.isElement(n2) && Editor.isInline(editor, n2) || Text.isText(n2);
        } else {
          match = (n2) => Element.isElement(n2) && Editor.isBlock(editor, n2);
        }
      }
      ...
      var roots = Array.from(Editor.nodes(editor, {
        at,
        match: editor.isInline(element) ? (n2) => Element.isElement(n2) && Editor.isBlock(editor, n2) : (n2) => Editor.isEditor(n2),
        mode: "lowest",
        voids
      }));
  ...
  insertFragment(editor, fragment) {
    ...
    Editor.withoutNormalizing(editor, () => {
      ...
      var inlineElementMatch = Editor.above(editor, {
        at,
        match: (n2) => Element.isElement(n2) && Editor.isInline(editor, n2),
        mode: "highest",
        voids
      });
      ...
      Transforms.splitNodes(editor, {
        at,
        match: (n2) => hasBlocks ? Element.isElement(n2) && Editor.isBlock(editor, n2) : Text.isText(n2) || Editor.isInline(editor, n2),
...
is-plain-object/dist/is-plain-object.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-RJ4PQR5M.js.map
